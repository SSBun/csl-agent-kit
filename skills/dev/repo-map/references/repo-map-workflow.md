...
Do not turn this into a durable, source-backed systematic report under `docs/analysis/`. A `repo-map` remains lightweight orientation even when it identifies some responsibilities and flows.
