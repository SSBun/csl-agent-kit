...
- Review: `APPROVED` after three cumulative passes; report: [move-agent-rules-to-super-agent](../artifacts/move-agent-rules-to-super-agent/reports/adversarial-review.md)
