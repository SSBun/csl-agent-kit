...
- [x] T1：将用户确认的 14 项探索指南保存到全新的 `tasks/artifacts/deep-explore-brooks-lint/reports/2026-08-07-brooks-lint/`，并逐项记录完成状态与来源。
...
- [x] T5：将用户确认的修订指南保存到新的 `tasks/artifacts/deep-explore-brooks-lint/reports/2026-08-07-brooks-lint-2/`，不覆盖首次探索。
...
- T1：已在全新目录 `tasks/artifacts/deep-explore-brooks-lint/reports/2026-08-07-brooks-lint/` 保存批准后的 `explore-guide.md`；P01–P14 均按顺序记录结论、来源状态并链接主报告。
...
- T5：新目录 `tasks/artifacts/deep-explore-brooks-lint/reports/2026-08-07-brooks-lint-2/` 已保存用户批准的 14 项修订指南；P01–P14 均按顺序完成并链接报告，首次探索目录未被复用或覆盖。
