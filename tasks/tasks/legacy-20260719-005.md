...
- `env -u NO_COLOR npm run check` 两次通过 53 项测试与 Codex 安装 dry-run；两项 Skill Creator/local quality gate 校验、21/21 与 23/23 trigger eval、JSON、SHA-256、秘密模式扫描及 `git diff --cached --check` 通过。
