...
3. Verify rule structure, focused diffs, and packaging references, then run the required Yao rule audit.
...
- T2: Each restored section now requires loading and following the matching workspace skill before acting; Yao trigger evaluation passed all 37 positive, negative, and near-neighbor cases across the three skills.
