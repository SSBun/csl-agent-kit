# Analyze Project v2 Output Eval — Trial 005

## Freeze

- Status: `FAIL`
- Trial ID: `analyze-project-v2-005`
...
| --- | --- | --- | --- |
| Baseline Develop | `/tmp/analyze-project-eval5.EJ9lgn/baseline-develop` | 禁止 | `docs/analysis/components/file/bin/csl-agent-kit.js.md` |
| With-skill Develop | `/tmp/analyze-project-eval5.EJ9lgn/skill-develop` | 冻结 skill | `docs/analysis/components/file/bin/csl-agent-kit.js.md` |
| Baseline Learn | `/tmp/analyze-project-eval5.EJ9lgn/baseline-learn` | 禁止 | `docs/analysis/learning/file/bin/csl-agent-kit.js.md` |
| With-skill Learn | `/tmp/analyze-project-eval5.EJ9lgn/skill-learn` | 冻结 skill | `docs/analysis/learning/file/bin/csl-agent-kit.js.md` |

## Sealed fixture

- Author: 独立 Sealed Author；不参与 skill 编辑或候选生成
- Creation point: Trial 005 fingerprint 冻结后、候选生成前
- Fixture ID: `learn-heldout-05a6c689-t05`
- Combined prompt/rubric SHA-256: `ab5a00d8543d670d82aee1c1d8c7aa42879a8da0cc61e49ec27c92cb70818dbd`
- Frozen at: `2026-07-19T15:11:53.094Z`
...
- `B-develop.md`: `c0bdaa6cea0f003de861c84b4ba31b1474e0ae178a39b8f651b67ea868ab1b56`
- `B-learn.md`: `6ff18c8bdc6b81feea9ced563a7d3872b2e2447d82310f86533a931b3c5a1a69`
- Identity mapping: sealed until scoring completes

## Result

- Random byte: `50`（even，预注册规则为 A=baseline、B=with-skill）
...
- Replay: 一致
- Failure: B 未满足 held-out H4（真实 failure source 与后续 adapter 的成对 CLI 验证）与 H5（具体 handler/effect primitive 锚点因果链）
- Scoring: `scoring.md`
