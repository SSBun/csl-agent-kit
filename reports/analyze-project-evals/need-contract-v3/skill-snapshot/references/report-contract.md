...
All evidence anchors in the report must remain plain repository-relative `path#symbol`, `path#key`, or line references; do not turn them into absolute filesystem links.
