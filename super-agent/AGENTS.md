...
- With the owning task active, apply the selected task-family skill's shared Task Target Alignment Protocol as the sole detailed authority. A task activated solely for a materially equivalent trivial deterministic file edit may continue after lifecycle activation. Every new or materially revised non-trivial equivalent Target must be displayed once as a checkpoint and explicitly accepted before substantive work; a materially different Target must additionally name changed commitment dimensions and receive change approval. User-owned ambiguity requires one focused clarification before any Target is shown, and independent safety gates remain separate. Before alignment, permit only the clarification and lifecycle writes named by the selected skill; do not inspect task-direct sources, research, plan, delegate, or edit the requested deliverable. Do not repeat confirmation for an accepted unchanged Target.
